...
//       style={{
//         backgroundImage: `url(${contact_back})`, // Use the imported image here
//       }}
//     >
...
//             </p>
//             <button className="mt-4 bg-transparent border border-white py-2 px-6 text-white font-semibold hover:bg-white hover:text-black transition">
//               LEARN MORE
//             </button>
//             <p className="text-sm mt-2">Images from Freepik</p>
//           </div>

//           {/* Contact Form Right Section */}
//           <div className="h-full w-full bg-gray-200 rounded-md bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-30 border border-gray-100 p-8 shadow-lg text-gray-900 space-y-6">
...
//             <div>
//               <label className="block text-white mb-2 text-xl ">Address</label>
//               <input
//                 type="text"
    ...
    >
      ...
      <div className="relative z-10 h-full flex items-center justify-center">
        <div className="text-white p-8 max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          {/* Contact Form Right Section */}
          <div className="h-full w-full bg-gray-200 rounded-md bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-30 border border-gray-100 p-12 shadow-lg text-gray-900 space-y-8"> {/* Increased padding */}
