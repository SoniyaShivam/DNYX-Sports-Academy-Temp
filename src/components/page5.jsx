...
const Page5 = () => {
  return (
    ...
    >
      ...
      <div className="relative z-10 h-full flex items-center justify-center">
        <div className="text-white p-8 max-w-5xl w-full h-full grid grid-cols-1 lg:grid-cols-2 gap-10">
          {/* Contact Us Left Section */}
          <div className="space-y-20">
            <h2 className="text-6xl font-bold">Contact Us</h2> {/* Increased font size */}
          ...
          {/* Contact Form Right Section */}
          <div className="h-full w-full  rounded-md bg-clip-padding bg-opacity-30 border border-gray-100 p-12 shadow-lg text-gray-900 space-y-8">
